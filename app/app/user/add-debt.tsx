    ...
    return (
        <View style={s.mainScreenA}>
            <View style={{flexGrow: 1, alignItems: "center", justifyContent: "center"}}>
                ...
                <TouchableOpacity style={s.hozButton} onPress={() => {router.navigate({pathname: "/user/manual-debt-overlay", params: {email: email}})}}><Text style={s.buttonText}>Enter Manually</Text></TouchableOpacity>
            </View>
