...
class Transactions(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    user_owed_id = db.Column(db.String(100), db.ForeignKey('user.user_id'), nullable=False)
    user_owing_id = db.Column(db.String(100), db.ForeignKey('user.user_id'), nullable=False)
