...
class Transactions(db.Model):
    id = id.Column(db.Intger, primary_key = True)
    user_owed_id = db.Column(db.String(100), foreign_key = ('user.username'), nullable=False)
    user_owing_id = db.Column(db.String(100), foreign_key = ('user.username'), nullable = False)
=======
